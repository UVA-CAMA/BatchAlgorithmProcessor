...
handles.algnames = {'CU Artifact Removal';'WUSTL Artifact Removal';'Brady<100';'Desat<80';'Apnea Detector with ECG Lead I';'Apnea Detector with ECG Lead II';'Apnea Detector with ECG Lead III';'Periodic Breathing';'Brady Pete';'Desat Pete'};
